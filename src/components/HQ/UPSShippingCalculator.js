...
// ---------------------------------------------------------------------------
// DATA: ZIP prefix → UPS ground zone (from origin 272xx, High Point NC)
// ---------------------------------------------------------------------------
...
function lookupRate(serviceKey, zone, billableWeight) {
...
export default function UPSShippingCalculator() {
  ...
  const calculate = useCallback(() => {
    ...
    const rate = lookupRate(selectedService, serviceZone, billableWeight);
    if (rate === null) {
