...
|---|---|---|---|
| S1 | started 09-10. Live pass done (BRIEF_S1 §7). **Live:** a58d126; 1259391; 16a74bb; bd5907e; e4ab15a; 6572b6f; 9415338; bb5b5e1; 38b1ba6 (H1-138TRV explosion re-keyed to arm + plate, S5's correction). Open on Stuart's side: single returns on a double (decision), H1-2TRV carrier `#43`, in-line stragglers; Kit Family `H1-138TRV` on the H1-138 flow (tab 11) + the 4.6 import for the kits. Open from S2: stamp a REFUSED estimate on the job (BRIEF_S1 §6). | 38b1ba6 | end-to-end kit read after Stuart's data; then S2's refused-stamp ask |
