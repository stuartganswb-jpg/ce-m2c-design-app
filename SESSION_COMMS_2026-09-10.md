...
| S5 | Display program: Designer b3fd59f · Build orders d3c6777 · Seed from tracker 9f5c714 · vertical poles + flow chips db928f4 (all live); handed S1 discount (shipped), S2 the snapshot Display column | db928f4 | Stuart: delete + re-seed the tabletop, pick the H1 flow; then the wall board; then build orders | 
