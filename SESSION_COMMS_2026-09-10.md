...
|---|---|---|---|
| S1 | started 09-10. **Live:** a58d126; 1259391; 16a74bb; bd5907e; e4ab15a; 6572b6f; 9415338; bb5b5e1; 38b1ba6; 2c61b3e; 26f45de (#45); b180339 (Vision Phase 0). **Project in flight (Stuart 23:30): Vision on the new engine** — Phase 0 drawings survive the save (live); Phase 1 pickers from the engine's slots (pure module + node proof, then the board); Phase 2 open/reopen both ways (CPQ → Vision write-back, re-save replaces the cart line); Phase 3 generator stops emitting TRV END steps. Open on Stuart's side: kit data; single returns on a double; carrier `#43`; in-line stragglers. | b180339 | Vision Phase 1 |
