...
| 2026-09-10 (push pending) | S2 | 9ddef72 | Reopen rules corrected from the first dry run: fulfilment queued/posted = shipped (kept); hand-reopened shop halves lose the closed flag; failed NetSuite writes go back to FAILED not PENDING. Row facts (packed/picked dates, last error) on the dry-run list. | everyone |
