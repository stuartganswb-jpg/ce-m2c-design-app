...
| S5 | Issue 1 (H1-138TRV kits) complete + live; Issue 2 = Sales Display Designer SHIPPED b3fd59f (5. Marketing); handed S1 the order-level discount (both doors) | b3fd59f | Stuart: first display entered via CPQ → cart → place (the tracker's tabletop); next S5 issue = build orders (→ 10.5) + the "Display" demand record for S2's snapshot column |
