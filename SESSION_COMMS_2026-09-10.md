...
| S5 | Display program: Designer b3fd59f · Build orders d3c6777 · Seed 9f5c714 · poles/chips db928f4 · row chooser 0a7bfa7 · true scale edfb8e3 (all live); S1 owes `displaySnapshot` (framed capture); S2 owes the snapshot Display column | edfb8e3 | Stuart: Place… the CPQ rows into Top Row 1 / 2 again (now to scale); wall board; build orders |
