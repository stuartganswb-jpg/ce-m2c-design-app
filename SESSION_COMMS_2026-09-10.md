...
| S5 | Display program: Designer b3fd59f · Build orders d3c6777 · Seed from tracker 9f5c714 (all live); H1-138TRV kits live; handed S1 order-level discount (S1 shipped 7d3f594), S2 the snapshot Display column | 9f5c714 | Stuart: Seed from tracker → the Fabricut tabletop + wall board; a build order on each; then S2's column once `display_demand_ce` is populated |
