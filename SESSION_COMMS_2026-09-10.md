...
|---|---|---|---|
| S1 | started 09-10. Live pass done (BRIEF_S1 §7). **Live:** a58d126 (HIDDEN- skip); 1259391 (CRM header edit); 16a74bb (CRM card); bd5907e (one step order); e4ab15a (`ridesWith`); 6572b6f (parked never rides); 9415338 (H1-138TRV explosion + rules by family); bb5b5e1 (plate follows its arm). Stuart's tag passes done; S1 wrote the last two on his ask (tier FRONT on 8 double-return fees; setup DOUBLE on 40 H1-75 6.5" plates), read back. Open on Stuart's side: single returns on a double (decision), H1-2TRV carrier `#43`, in-line stragglers; S5's push + Kit Family tag + 4.6 import for the H1-138TRV kits. | bb5b5e1 | end-to-end kit read; then BRIEF_S1 §3 |
